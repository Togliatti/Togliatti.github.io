        ...
        var z = (e.frame =
          ...
          N = l(function (e) {
            ...
            ((e.init = function (e) {
              ...
              O.backface &&
                H.hideBackface &&
                B(this.el, O.backface.css, "hidden");
            }),
              w("add", n),
              w("start", i),
              w("wait", function (t) {
        ...
        (t.exports = function (t, e) {
          ...
          function L(n, i) {
            ...
            (v ||
              ...
              (v.outside =
                ((r = v).outside && h.off("click" + m, r.outside),
                function (e) {
                  var n = t(e.target);
          ...
          function C(t) {
            t.overlay && (W(t, !0), t.overlay.remove(), (t.overlay = null));
          }
          function O(t) {
            var n = {},
              i = t.config || {},
            ...
            l.preview =
              function () {
                ((u = v && i.env("design")),
                  (c = i.env("editor")),
                  (n = t(document.body)),
                  (s = h.find(m)).length && (s.each(L), _(), i.resize.on(A)));
              }),
            (l.destroy = function () {
              ((k = t()), _(), s && s.length && s.each(T));
            }));
          ...
          function S(e, n) {
            ...
            if ((!i.open || r || u || W(i, !0), i.container.length)) {
              var o,
                a =
